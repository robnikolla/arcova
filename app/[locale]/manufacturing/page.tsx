...
export const metadata: Metadata = {
  title: "Manufacturing — One line, one roof, one QC pass",
  description:
    "Every Arcova opening is cut, welded, glazed, gasketed and QC-tested in the same building in Ferizaj, Kosovo. Nothing is outsourced.",
};
      ...
      <main>
        ...
        <section style={{ borderBottom: "1px solid var(--line)" }}>
          <div className="container" style={{ padding: "64px var(--pad-x) 0" }}>
            ...
            <h1
              style={{ textWrap: "balance", marginBottom: 40, maxWidth: 1100 } as React.CSSProperties}
            >
              One line, one roof,
              <br />
              one QC pass.
            ...
            >
              <p style={{ fontSize: 20, color: "var(--ink-2)", lineHeight: 1.45, textWrap: "pretty" } as React.CSSProperties}>
          ...
          <Placeholder aspect="21/8" src="https://picsum.photos/seed/plant-wide/2100/800" label="PLANT · A">
            <div
              style={{
                position: "absolute",
                left: 24,
            ...
            >
              <span style={{ background: "var(--bg)", padding: "6px 10px", border: "1px solid var(--line-2)" }}>
                42.3706°N 21.1551°E
              </span>
              <span style={{ background: "var(--bg)", padding: "6px 10px", border: "1px solid var(--line-2)" }}>
                14,200 m² · 1 building
        ...
        >
          <div className="container">
            ...
            <h2
              style={{ color: "var(--bg)", textWrap: "balance", marginBottom: 80, maxWidth: 900 } as React.CSSProperties}
            >
              Nine stations.
              <br />
              One continuous flow.
              ...
              {processBlocks.map((b, i) => (
                ...
                >
                  <div style={{ order: i % 2 === 0 ? 1 : 2 }}>
                    <Placeholder
                      aspect="4/3"
                      src={`https://picsum.photos/seed/${b.imgSeed}/1200/900`}
                      label={`PROC · ${b.n}`}
                    />
                  </div>
          ...
          <div className="container">
            ...
            <div style={{ border: "1px solid var(--line-2)" }}>
              ...
              {zones.map((z, i) => (
                ...
                >
                  <span style={{ fontFamily: "var(--f-mono)", fontWeight: 500, color: "var(--accent)" }}>
                    {z.z}
                  </span>
