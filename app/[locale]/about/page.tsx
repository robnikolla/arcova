...
export const metadata: Metadata = {
  title: "About — A window factory, built for architects",
  description:
    "Arcova manufactures made-to-order windows, doors and shutters in Ferizaj, Kosovo — on aluplast and Salamander profiles engineered in Germany.",
};
...
export default async function AboutPage({
  ...
  const portraitSeeds = [
    "portrait-m1", "portrait-f1", "portrait-m2",
    "portrait-f2", "portrait-m3", "portrait-f3",
  ];
  ...
  const principles = [
    {
      n: "01",
      t: "No stock. Everything made to order.",
      d: "We don't hold finished windows. Every opening is cut to your drawing, glazed to your spec, and boxed with your project code.",
    },
    {
      n: "02",
      t: "The drawing is the contract.",
      d: "We sign your CAD back to you before production. Any deviation over 2 mm is flagged, approved in writing, and logged in the QC record.",
    },
    {
      n: "03",
      t: "German profile, Kosovo plant.",
      d: "aluplast and Salamander extrude in Germany. We fabricate, glaze, and QC in Ferizaj. The value is in the engineering — on both ends of that chain.",
    },
    {
      n: "04",
      t: "Lead time is a promise.",
      d: "Quoted windows ship in 18–22 days. We held 96.2% on-time in 2025. Late orders are credited — it's in the contract.",
    },
  ];
      ...
      <main>
        ...
        <section style={{ borderBottom: "1px solid var(--line)" }}>
          <div className="container" style={{ padding: "64px var(--pad-x) 96px" }}>
            <div className="eyebrow" style={{ marginBottom: 48 }}>
              ...
              <span className="dot" />
              <span>Company · Ferizaj, Kosovo · Est. 2011</span>
            </div>
            <h1
              style={{ textWrap: "balance", maxWidth: 1100, marginBottom: 40 } as React.CSSProperties}
            >
              A window factory,
              <br />
            ...
            >
              <p style={{ fontSize: 20, lineHeight: 1.45, color: "var(--ink-2)", textWrap: "pretty" } as React.CSSProperties}>
                Arcova manufactures made-to-order windows, doors and shutters in
                Ferizaj, Kosovo — on <strong>aluplast</strong> and{" "}
                <strong>Salamander</strong> profiles engineered in Germany.
              </p>
              <p style={{ fontSize: 15, lineHeight: 1.7, color: "var(--muted)", textWrap: "pretty" } as React.CSSProperties}>
                We ship to 19 countries. We hold quoted lead times at 96.2%. We
                sign drawings back to the architect before anything is cut. That
                discipline — and fifteen years doing only this — is the company.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container" style={{ padding: "64px var(--pad-x)" }}>
            ...
            >
              ...
              {[
                ...
                <div
                  key={p.n}
                  style={{ borderLeft: "1px solid var(--line-2)", paddingLeft: 32 }}
                >
                  <div
                    style={{
                      display: "flex",
          ...
          <div className="container">
            ...
            >
              <div style={{ position: "sticky", top: 96 }}>
                <Placeholder
                  aspect="4/5"
                  src="https://picsum.photos/seed/portrait-m1/600/750"
                  label="FOUNDER · 01"
                />
                <div
                  style={{
              ...
              <div>
                ...
                <h2 style={{ textWrap: "balance", marginBottom: 40 } as React.CSSProperties}>
                ...
                >
                  <p>
                    Arcova was founded in 2011 in a 400&nbsp;m² workshop outside
                    Ferizaj. The first year shipped 112 windows — mostly to
                    neighbours rebuilding homes.
                  </p>
                  <p>
                    In 2014, we became certified fabricators of{" "}
                    <strong>aluplast</strong> profiles and started quoting
                    commercial projects in Austria and Germany. Two years later we
                    added <strong>Salamander</strong> for the premium segment. The
                    plant grew with the order book — 14,200&nbsp;m² by 2022, with
                    a second glass laminating line in 2024.
                  </p>
                  <p>
                    The company never changed what it makes. Every expansion was in
                    service of doing the same thing — specifying, cutting, glazing,
                    shipping openings — with less variance and more capacity.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              {team.map((t, i) => (
                <div key={t.name}>
                  <Placeholder
                    aspect="4/5"
                    src={`https://picsum.photos/seed/${portraitSeeds[i]}/600/750`}
                    label={`P·0${i + 1}`}
                  />
        ...
        >
          <div className="container" style={{ padding: "100px var(--pad-x)" }}>
            <div
              className="eyebrow"
              style={{ color: "rgba(255,255,255,0.55)", marginBottom: 32 }}
            >
            ...
            <div>
              {events.map((e, i) => (
                <div
                  ...
                  style={{
                    display: "grid",
                    gridTemplateColumns: "140px 1fr 2fr 80px",
                    gap: 24,
                    alignItems: "start",
                    padding: "28px 0",
