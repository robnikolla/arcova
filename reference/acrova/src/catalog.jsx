...
function Catalog({ setPage, onQuote }) {
  ...
  const allImgs = [
    IMGS.facade_geometric,
    IMGS.facade_metallic,
    IMGS.arch_b,
    IMGS.arch_a,
    IMGS.arch_c,
    IMGS.facade_brick,
  ...
  const products = [
    ...
    },
    {
      ...
      rw: 46,
      rc: "RC2",
      systems: ["alu 6060-T66"],
      new: true,
    },
    {
      id: "PW-76",
      name: "PVC Window 76 · aluplast",
      family: "windows",
      profile: "pvc",
      tag: "Standard",
      uw: 0.82,
      rw: 42,
      rc: "RC2",
      systems: ["aluplast IDEAL 4000"],
      new: false,
    },
    {
      id: "PW-88",
      name: "PVC Window 88 · aluplast",
      family: "windows",
      profile: "pvc",
      tag: "Premium",
      uw: 0.74,
      rw: 44,
      rc: "RC2",
      systems: ["aluplast IDEAL 8000"],
      new: false,
    },
    {
      id: "PW-70S",
      name: "PVC Window 70 · Salamander",
      family: "windows",
      profile: "pvc",
      tag: "Standard",
      uw: 0.84,
      rw: 41,
      rc: "RC2",
      systems: ["Salamander streamline 76"],
      new: false,
    },
    {
      id: "PW-92S",
      name: "PVC Window 92 · Salamander",
      family: "windows",
      profile: "pvc",
      tag: "Premium",
      uw: 0.72,
      rw: 45,
      rc: "RC3",
      systems: ["Salamander bluEvolution 92"],
      new: true,
    },
    {
      id: "ED-120",
    ...
    },
    {
      ...
      rw: 32,
      rc: null,
      systems: ["Aluminium slat 45"],
      new: false,
    },
    {
      id: "CW-60",
      name: "Curtain Wall CW-60",
      family: "curtain",
      profile: "alu",
      tag: "Structural",
      uw: 1.1,
  ...
  const families = [
    { k: "all", l: "All systems", count: products.length },
    {
      k: "windows",
      l: "Windows",
      count: products.filter((p) => p.family === "windows").length,
    },
    {
      k: "doors",
      l: "Doors",
      count: products.filter((p) => p.family === "doors").length,
    },
    {
      k: "sliding",
      l: "Sliding",
      count: products.filter((p) => p.family === "sliding").length,
    },
    {
      k: "shutters",
      l: "Shutters",
      count: products.filter((p) => p.family === "shutters").length,
    },
    {
      k: "curtain",
      l: "Curtain walls",
      count: products.filter((p) => p.family === "curtain").length,
    },
  ];
  ...
  if (sortBy === "uw")
    filtered = [...filtered].sort((a, b) => (a.uw ?? 99) - (b.uw ?? 99));
  if (sortBy === "rw")
    filtered = [...filtered].sort((a, b) => (b.rw ?? 0) - (a.rw ?? 0));
  if (sortBy === "id")
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: 10,
                    color:
                      activeFamily === f.k ? "var(--accent)" : "var(--muted)",
                    letterSpacing: 0,
                  }}
                >
                  {f.count}
                  ...
                  style={{
                    ...
                    borderRight:
                      i < profiles.length - 1
                        ...
                        : "none",
                    background:
                      activeProfile === p.k ? "var(--ink)" : "transparent",
        ...
        <div className="container" style={{ padding: "56px var(--pad-x)" }}>
          ...
          >
            <div>
              ...
              >
                PVC systems run on{" "}
                <strong style={{ color: "var(--ink)" }}>aluplast</strong> (IDEAL
                4000, IDEAL 8000) and{" "}
                <strong style={{ color: "var(--ink)" }}>Salamander</strong>{" "}
                (streamline 76, bluEvolution 92) profiles extruded in Germany.
              </p>
            </div>
            <div>
              <div className="eyebrow" style={{ marginBottom: 16 }}>
              ...
              <p
                style={{ fontSize: 15, color: "var(--muted)", lineHeight: 1.6 }}
              >
                Aluminium openings use 6060-T66 extrusion with polyamide
                PA66-GF25 thermal break. Powder coated to AAMA 2605.
              </p>
            </div>
            <div
              style={{
            ...
            >
              <button className="btn btn-primary btn-sm" onClick={onQuote}>
                Request comparison quote <Arrow size={12} />
              </button>
            </div>
          </div>
        </div>
  ...
  return (
    <div style={{ border: "1px solid var(--line-2)", overflow: "hidden" }}>
      ...
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "90px 1.5fr 80px 100px 100px 80px 80px 1fr 48px",
          background: "var(--ink)",
          color: "var(--bg)",
        }}
      >
      ...
      {products.map((p, i) => (
        <div
          ...
          style={{
            display: "grid",
            gridTemplateColumns:
              "90px 1.5fr 80px 100px 100px 80px 80px 1fr 48px",
            borderTop: "1px solid var(--line)",
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background =
              "color-mix(in oklab, var(--accent) 6%, var(--bg))")
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background =
              i % 2 === 0 ? "var(--bg)" : "var(--bg-2)")
          }
        >
          <div
            style={{
          ...
          <div
            style={{
              ...
              fontFamily: "var(--f-mono)",
              fontSize: 13,
              color: p.rc === "RC3" ? "var(--accent)" : "var(--ink)",
            }}
          >
            {p.rc ?? "—"}
          </div>
