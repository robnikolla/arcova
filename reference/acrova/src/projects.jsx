                ...
                style={{
                  ...
                  borderRight:
                    i < countries.length - 1
                      ...
                      : "none",
                  background:
                    activeCountry === c.k ? "var(--ink)" : "transparent",
          ...
          <div style={{ marginBottom: 80 }}>
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns:
                  featuredProjects.length === 1 ? "1fr 1fr" : "1fr 1fr",
                gap: 32,
              }}
            >
...
function ProjectDetail({ project: p, onBack, onQuote }) {
  ...
  return (
    <main>
      ...
      >
        ...
        >
          ...
          >
            ...
            <h1 style={{ color: "#fff", textWrap: "balance", maxWidth: 900 }}>
              {p.name}
            </h1>
          </div>
        </Placeholder>
      ...
      {/* Brief + image gallery */}
      <section
        style={{ borderBottom: "1px solid var(--line)", padding: "96px 0" }}
      >
        <div className="container">
          ...
          >
            ...
            <div style={{ position: "sticky", top: 96 }}>
              ...
              <h2 style={{ textWrap: "balance", marginBottom: 32 }}>
                The brief.
              </h2>
              <div
                style={{
              ...
              >
                <p>
                  ...
                  {p.systems.join(" and ")} systems for {p.name} in {p.location}
                  , requiring made-to-order openings across {p.openings}{" "}
                  positions in the facade.
                </p>
                <p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <Placeholder
                aspect="4/3"
                src={
                  [p.img, IMGS.arch_e, IMGS.arch_f, IMGS.arch_g][activeImage]
                }
              ...
              >
                {images.map((img, i) => (
                  ...
                  >
                    <Placeholder
                      aspect="4/3"
                      src={[p.img, IMGS.arch_e, IMGS.arch_f, IMGS.arch_g][i]}
                    />
                  </button>
                ))}
              </div>
      ...
      >
        <div className="container">
          <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
            ...
            >
              "The drawings came back signed within 48 hours. Every opening
              arrived on the same truck, plumb to the millimetre. That's not
              common."
            </blockquote>
          </div>
        </div>
      ...
      >
        <div className="container">
          ...
          >
            {[
              {
                t: "Signed architectural drawings",
                ext: "PDF",
                note: "R.07 · as-built",
              },
              {
                ...
                ext: "XLSX",
                note: "All openings with references",
              },
              {
